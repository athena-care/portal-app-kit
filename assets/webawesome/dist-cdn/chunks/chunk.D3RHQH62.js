...
var WaFileInput = class extends WebAwesomeFormAssociatedElement {
    ...
    return x`
      <li part="file" class="file">
        <span part="file-thumbnail" class="file-thumbnail">
          ${isImage ? x`<img part="file-image" class="file-image" src=${this.getObjectUrl(file)} alt="" />` : x`<wa-icon part="file-icon" library="system" name=${iconName}></wa-icon>`}
        </span>
  ...
  render() {
    ...
    return x`
      ...
      <div part="base file-input" class="file-input">
        <label
          id="dropzone"
          part="dropzone"
          for="file-input"
...
__decorateClass([
  watch("size")
], WaFileInput.prototype, "handleSizeChange", 1);
__decorateClass([
  n()
...
__decorateClass([
  n()
], WaFileInput.prototype, "capture", 2);
__decorateClass([
