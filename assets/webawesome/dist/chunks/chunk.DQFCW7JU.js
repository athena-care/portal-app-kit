    ...
    return html`
      <li part="file" class="file">
        <span part="file-thumbnail" class="file-thumbnail">
          ${isImage ? html`<img part="file-image" class="file-image" src=${this.getObjectUrl(file)} alt="" />` : html`<wa-icon part="file-icon" library="system" name=${iconName}></wa-icon>`}
        </span>
